      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="relative mt-24 flex items-center justify-center">
          <div className="relative z-20 flex h-44 w-44 items-center justify-center rounded-full border border-slate-200 bg-white shadow-[0_10px_40px_rgba(0,0,0,0.06)] translate-y-1">
            <div className="text-center">
              <div className="text-xl font-bold text-blue-600">ZeoFex</div>
            ...
            {orbitOne.map((partner, i) => (
              ...
              >
                <a
                  ...
                  className="group flex h-16 w-16 items-center justify-center rounded-full border border-slate-200 bg-white shadow-sm transition-transform duration-300 hover:scale-110 hover:border-blue-300"
                >
                  <Image
                    src={partner.logo}
                    alt={partner.name}
            ...
            {orbitTwo.map((partner, i) => (
              ...
              >
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex h-14 w-14 items-center justify-center rounded-full border border-slate-200 bg-white shadow-sm transition-transform duration-300 hover:scale-110 hover:border-sky-300"
                >
                  <Image
                    src={partner.logo}
                    alt={partner.name}
