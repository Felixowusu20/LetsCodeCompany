...
export const privacyDocument: LegalDocument = {
  path: "/privacy",
  pageTitle: `Privacy Policy | ${LEGAL_ENTITY}`,
  metaDescription: `How ${LEGAL_ENTITY} collects, uses, stores, and protects personal data across our products and websites.`,
  heading: "Privacy Policy",
  categoryLabel: "Legal",
  intro: [
    `This Privacy Policy describes how ${LEGAL_ENTITY} ("we," "us," or "our") processes personal information when you use our websites, applications (including VentraPOS.com), and related services.`,
  ...
  sections: [
    ...
    },
    {
      ...
      subsections: [
        {
          title: "2.1 Account and contact details",
          paragraphs: [
        ...
        {
          title: "2.3 Location and device data",
          paragraphs: [
        ...
        {
          title: "2.5 Marketplace and collaboration content",
          paragraphs: [
        ...
        {
          title: "2.6 Cookies and similar technologies",
          paragraphs: [
    ...
    },
    {
      ...
      subsections: [
        {
          title: "5.1 Infrastructure and application hosting",
          paragraphs: [
    ...
    },
    {
      ...
      subsections: [
        {
          title: "9.1 Access and correction",
          paragraphs: [
        ...
        {
          title: "9.4 Objection and restriction",
          paragraphs: [
        ...
        {
          title: "9.5 Marketing opt-in and cookies",
          paragraphs: [
    ...
    {
      title: "12. Ghana and international framing",
      paragraphs: [
        `${LEGAL_ENTITY} is committed to compliance with the Data Protection Act, 2012 (Act 843) of Ghana, including principles of lawful processing, data security, and data subject rights, where applicable to our activities.`,
